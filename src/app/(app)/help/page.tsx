      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 max-w-3xl space-y-6">
          <Section id="start" icon={LogIn} title="เริ่มต้นใช้งาน">
            <Steps items={[
              ["เข้าสู่ระบบ", "หน้า Login กรอกชื่อผู้ใช้ + PIN ที่ตั้งไว้ตอนสมัคร (ร้านใหม่สมัครที่ /signup ทดลองฟรี 14 วัน). owner/manager เพิ่มผู้ใช้และตั้ง PIN ให้พนักงานได้ที่ ตั้งค่า > ผู้ใช้"],
          ...
          <Section id="menu" icon={BookOpen} title="เมนู สูตร ราคาตามเวลา">
            <Steps items={[
              ...
              ["จัดการหมวด", "ปุ่ม 'เพิ่มหมวด' สร้างหมวดใหม่ (+ จุดครัว station). หัวแต่ละหมวดมีปุ่ม: เลื่อนลำดับ ⬆⬇ / แก้ไขชื่อ-จุดครัว / ลบ (ลบได้เฉพาะหมวดที่ไม่มีเมนู — ย้ายเมนูออกก่อน). จุดครัวต่อหมวดใช้ route ตั๋วครัวไปเครื่องพิมพ์ของจุดนั้น"],
              ["รูปเมนู", "ในหน้าเพิ่ม/แก้เมนู กด 'อัปโหลดรูป' เลือกรูปอาหาร (ระบบย่อขนาดให้อัตโนมัติ) — รูปแสดงบนปุ่มเมนูที่จอขาย, กด 'ลบรูป' เพื่อเอาออก"],
          ...
          <Section id="settings" icon={Settings} title="ตั้งค่า / เครื่องพิมพ์">
            <Steps items={[
              ...
              ["โหมดพิมพ์ (สำคัญถ้ารันบน cloud)", "ในแถบเครื่องพิมพ์ เลือกโหมด: 'ตรง (LAN)' = เซิร์ฟเวอร์สั่งพิมพ์ไป printer โดยตรง (เมื่อรันในร้าน). 'ผ่าน Agent (cloud)' = เมื่อรันบน cloud (เช่น Vercel/iPad) ที่เข้า printer ใน LAN ไม่ได้ → ระบบสร้าง token ให้, รันโปรแกรม print-agent (scripts/print-agent.mjs) บนเครื่องในร้านที่ถึง printer — agent ดึงงานไปพิมพ์/เปิดลิ้นชักให้"],
              ["รับชำระบัตร / QR", "ตั้งค่าธุรกิจ: เลือก provider (Mock/Omise) ใส่ Omise key เพื่อรับบัตรจริง. รับ QR: ใส่ PromptPay ID ของร้าน → POS โชว์ 'QR พร้อมเพย์' ลูกค้าสแกนจ่าย (แอปธนาคาร/แม่มณี). ปัจจุบันแคชเชียร์ยืนยันการชำระเอง; auto-confirm ผ่าน KBank API ต่อภายหลังได้"],
            ]} />
            <Tip><Printer className="h-3.5 w-3.5 inline" /> โหมด 'ตรง': เครื่องพิมพ์ต้อง network เดียวกับ POS → ใส่ IP → ทดสอบ. รันบน cloud + iPad: ใช้โหมด 'ผ่าน Agent' (มีโปรแกรม print-agent ในร้านดึงงานไปพิมพ์)</Tip>
          </Section>
